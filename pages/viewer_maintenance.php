...
<body>
        ...
        <div class="viewer-container">
                        ...
                        <div class="vm-alert-dropdown-inner">
                            ...
                            ?>
                                <div class="vm-alert-system-row">
                                    ...
                                    <?php else: ?>
                                        <div class="vm-alert-system-logo-placeholder"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="vm-page-header">
                <div class="vm-title-block">
                    <div class="vm-title-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <?php if (empty($schedules)): ?>
                <div class="vm-allclear">
                    <div class="vm-allclear-icon"><svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="vm-card vm-card-animate"
                            ...
                            <div class="vm-card-top">
                                <div class="vm-system-identity">
                                    ...
                                    <?php else: ?>
                                        <div class="vm-system-logo-placeholder"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                <rect x="3" y="3" width="7" height="7"></rect>
                                                <rect x="14" y="3" width="7" height="7"></rect>
                                                <rect x="14" y="14" width="7" height="7"></rect>
                                                <rect x="3" y="14" width="7" height="7"></rect>
    ...
    <div class="vm-bottom-sheet" id="vmBottomSheet" role="dialog" aria-modal="true" aria-label="Filter options">
        ...
        <div class="vm-sheet-header">
            ...
            <button class="vm-sheet-close" onclick="vmCloseFilterSheet()" aria-label="Close"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
